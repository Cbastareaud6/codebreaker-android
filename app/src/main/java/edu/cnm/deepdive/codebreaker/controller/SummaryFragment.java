...
public class SummaryFragment extends Fragment implements OnSeekBarChangeListener {
  ...
  private static final float MILLISECONDS_PER_SECONDS = 1000.0f;
    ...
    viewModel
        ...
        .observe(getViewLifecycleOwner(), (summary) -> {
          if (summary == null) {
            ...
            binding.minTime.setText(getDuration(summary.getMaxTime()));
...
// do nothing
  ...
  private String getDuration( int milliseconds){
    ...
    int seconds = Math.round(milliseconds / MILLISECONDS_PER_SECONDS);
